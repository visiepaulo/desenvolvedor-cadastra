...
const dev = () => {
    watch(paths.scripts.watch, { ignoreInitial: false }, scripts).on('change', browserSync.reload)
    watch(paths.styles.src, { ignoreInitial: false }, styles)
    watch(paths.img.src, { ignoreInitial: false }, img)
    watch(paths.html.src, { ignoreInitial: false }, html).on('change', browserSync.reload)
    server()
}
